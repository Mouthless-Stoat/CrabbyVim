...
pub(crate) fn highlights() -> nvim_oxi::Result<()> {
    ...
    set_hl(Comment, HighlightOpt::with_fg(Gray))?;

    set_hl(String, HighlightOpt::with_fg(Green))?;
    set_hl(Number, HighlightOpt::with_fg(Orange))?;
    set_hl(Float, HighlightOpt::link(Number))?;
    set_hl(Boolean, HighlightOpt::with_fg(Orange))?;
    set_hl(Character, HighlightOpt::with_fg(Orange))?;
    set_hl(Structure, HighlightOpt::with_fg(Yellow))?;

    set_hl(Identifier, HighlightOpt::with_fg(Red))?;
    set_hl(Constant, HighlightOpt::with_fg(Yellow))?;
    set_hl(Member, HighlightOpt::with_fg(Cyan))?;
    set_hl(Builtin, HighlightOpt::with_fg(Purple))?;

    set_hl(Function, HighlightOpt::with_fg(Blue))?;
    set_hl(Statement, HighlightOpt::with_fg(Purple))?;
    set_hl(Keyword, HighlightOpt::with_fg(Purple))?;

    set_hl(Preproc, HighlightOpt::with_fg(Purple))?;
    set_hl(Type, HighlightOpt::with_fg(Orange))?;

    set_hl(Operator, HighlightOpt::with_fg(Cyan))?;
    set_hl(Special, HighlightOpt::with_fg(Pink).italic())?;
    set_hl(Delimiter, HighlightOpt::with_fg(Gray))?;
    ...
    set_lsp_hl("enumMember", HighlightOpt::with_fg(Yellow).italic())?;
